...
@section('title', 'Tambah Servis Baru - Admin Dashboard')
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-xs sm:text-sm text-white/60 mt-2">
                    Tambahkan data servis laptop ke sistem FIXLAPBOT ID.
                </p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.links.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input
                    ...
                    name="title"
                    value="{{ old('title') }}"
                    placeholder="Contoh: ASUS ROG - Laptop Tidak Menyala"
                    required
            ...
            <div class="space-y-3">
                ...
                <div id="preview-wrapper" class="relative overflow-hidden rounded-2xl service-soft transition-colors duration-200">
                    ...
                    <div id="preview-empty" class="flex flex-col items-center justify-center gap-3 py-10 px-6 cursor-pointer hover:bg-white/5">
                        <div class="w-14 h-14 rounded-2xl bg-blue-400/15 border border-blue-300/30 flex items-center justify-center text-blue-200">
                    ...
                    <div id="preview-filled" class="hidden">
                        <img id="preview-img" src="" alt="Pratinjau Berkas" class="w-full max-h-72 object-contain bg-black/20">
                        ...
                        <div class="flex justify-between items-center p-4 bg-black/20 border-t border-white/10">
                            ...
                            <button
                                type="button"
                                id="preview-remove"
                                class="service-button text-xs text-rose-200 bg-rose-400/15 font-extrabold px-3.5 py-2 rounded-lg border border-rose-300/30 hover:bg-rose-400/25"
                            >
                                Hapus Gambar
                            </button>
                        </div>
            ...
            <div class="pt-2">
                <label for="is_active" class="cursor-pointer select-none">
                    <div class="flex items-center justify-between gap-4 service-soft rounded-2xl p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span id="is_active_hint" class="text-[11px] font-semibold text-white/45">
                        ...
                        <span class="relative w-12 h-7 bg-white/15 peer-checked:bg-emerald-400/60 rounded-full border border-white/30 transition-colors shrink-0 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:w-5 after:h-5 after:bg-white after:rounded-full after:transition-transform peer-checked:after:translate-x-5"></span>
                    </div>
                </label>
            </div>

            <!-- TOMBOL AKSI -->
            <div class="pt-6 border-t border-dashed border-white/15 flex justify-end gap-3">
                ...
                <button
                    type="submit"
                    class="service-button bg-blue-400 hover:bg-blue-300 text-slate-950 font-extrabold py-3 px-8 rounded-xl flex items-center gap-2 shadow-lg shadow-blue-500/15"
                >
